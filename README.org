...
** Customizable parsers
   ...
   overriding technique described [[https://web.archive.org/web/20180210115730/http://neilmitchell.blogspot.com.br/2008/04/optional-parameters-in-haskell.html][here]]. you then use the =read*With=
